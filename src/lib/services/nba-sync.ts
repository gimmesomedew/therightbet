...
if (!ODDS_API_KEY) {
	throw new Error('ODDS_API_KEY environment variable is required for NBA');
}
...
function generateAbbreviation(teamName: string, providedAbbr: string | null = null): string {
...
export async function syncNBAMatchups() {
